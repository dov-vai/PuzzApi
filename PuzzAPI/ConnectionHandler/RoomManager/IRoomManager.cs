...
{
    bool CreateRoom(string title, int pieces, bool publicRoom, bool guests, out string? roomId);
    bool AddPeer(string id, WebSocket socket, bool guest, out string? peerId);
